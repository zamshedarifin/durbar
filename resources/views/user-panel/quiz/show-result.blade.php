                ...
                <div class="col-md-8 mt-3 mx-auto">
                    <div class="card p-4 quiz-border">
                        ...
                        @if(asset(Auth::user()->avatar) != null)
                            <img src="{{asset(Auth::user()->avatar)}}"  class="src card-image mx-auto shadow-sm mt-1 p-2" style="height: 120px; width: 120px">
                        @elseif(Auth::user()->avatar)
                            <img src="{{Auth::user()->avatar}}"  class="src card-image mx-auto shadow-sm mt-1 p-2" style="height: 120px; width: 120px">
                        @else
