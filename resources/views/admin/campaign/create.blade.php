...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div>
                    <h4 class="header-title mb-3">Create New Campaign</h4>
                </div>
            </div>
        </div>
        <!-- end row -->
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        <form class="form-row" action="{{route('admin.create.campaign')}}" enctype="multipart/form-data" method="post">@csrf
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea name="short_desc" rows="5" id="short_desc" class="form-control  @error('short_desc') is-invalid @enderror">{{old('short_desc')}}</textarea>
                                @error('short_desc')
                                <div class="invalid-feedback"><i class="fa fa-exclamation-triangle"></i> {{$message}}</div>
                                @enderror
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <textarea name="short_desc_bn" rows="5" id="short_desc_bn" class="form-control  @error('short_desc_bn') is-invalid @enderror">{{old('short_desc_bn')}}</textarea>
                                @error('short_desc_bn')
                                <div class="invalid-feedback"><i class="fa fa-exclamation-triangle"></i> {{$message}}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="text" name="cam_date" autocomplete="off" placeholder="DD-MM-YYYY" value="{{old('cam_date')}}" id="cam_date" class="form-control datepicker  @error('cam_date') is-invalid @enderror">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="status" id="status" class="form-control  @error('status') is-invalid @enderror">
                                    ...
                                    <option value="4" {{old('status')=='4'?'selected':''}}>Previous</option>
                                    <option value="1" {{old('status')=='1'?'selected':''}}>Ongoing</option>
