...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div>
                    <h4 class="header-title mb-3">EDIT STORY</h4>
                </div>
            </div>
        </div>
        <!-- end row -->
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        <form class="form-row" action="{{route('admin.edit.story',lock($story->id))}}"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" value="{{$story->title_bn}}" name="title_bn" id="title_bn"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea name="description" rows="5" id="description"
                                          class="form-control summernote  @error('description') is-invalid @enderror">{{$story->description}}</textarea>
                                @error('description')
                                <div class="invalid-feedback"><i class="fa fa-exclamation-triangle"></i> {{$message}}
                                </div>
                                @enderror
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea name="description_bn" rows="5" id="short_desc_bn"
                                          class="form-control summernote  @error('description_bn') is-invalid @enderror">{{$story->description_bn}}</textarea>
                                ...
                                <select name="campaign" id="campaign"
                                    ...
                                    @if($campaigns)
                                        @foreach($campaigns as $campaign)
                                            <option value="{{$campaign->id}}" {{$campaign->id == $story->campaign->id?'selected':''}}>{{$campaign->title}}</option>
                                        @endforeach
                                    @endif
                                </select>
                                @error('campaign')
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" name="date" autocomplete="off" placeholder="DD-MM-YYYY"
                                           value="{{$story->published_date}}" id="date"
