...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div>
                    <h4 class="header-title mb-3">Create New Quiz</h4>
                </div>
            </div>
        </div>
        <!-- end row -->
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        <form class="form-row" action="{{route('admin.create.quiz')}}" enctype="multipart/form-data" method="post">@csrf
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea name="quiz_rules" rows="5" id="quiz_rules" class="form-control summernote  @error('quiz_rules') is-invalid @enderror">{{old('quiz_rules')}}</textarea>
                                @error('quiz_rules')
                                <div class="invalid-feedback"><i class="fa fa-exclamation-triangle"></i> {{$message}}</div>
                                @enderror
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <textarea name="quiz_rules_bn" rows="5" id="short_desc_bn" class="form-control summernote  @error('quiz_rules_bn') is-invalid @enderror">{{old('quiz_rules_bn')}}</textarea>
                                @error('quiz_rules_bn')
                                <div class="invalid-feedback"><i class="fa fa-exclamation-triangle"></i> {{$message}}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="tel" name="time" autocomplete="off"  value="{{old('time')}}" id="time" class="form-control  @error('time') is-invalid @enderror">
                                    <div class="input-group-append">
