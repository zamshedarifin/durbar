...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div>
                    <h4 class="header-title mb-3">EDIT COMPETITION</h4>
                </div>
            </div>
        </div>
        <!-- end row -->
        ...
        <div class="row justify-content-center">
            <div class="col-lg-9">
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        <form class="form-row" action="{{route('admin.edit.competition',lock($competition->id))}}"
                              enctype="multipart/form-data" method="post">@csrf
                            <div class="form-group col-md-6">
                                <label for="title">Title<span class="text-danger">* [English]</span></label>
                                <input type="text" value="{{$competition->title}}" name="title" id="title"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" value="{{$competition->title_bn}}" name="title_bn" id="title_bn"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea name="description" rows="5" id="description"
                                          class="form-control summernote  @error('description') is-invalid @enderror">{{$competition->description}}</textarea>
                                @error('description')
                                <div class="invalid-feedback"><i class="fa fa-exclamation-triangle"></i> {{$message}}
                                </div>
                                @enderror
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea name="description_bn" rows="5" id="short_desc_bn"
                                          class="form-control summernote  @error('description_bn') is-invalid @enderror">{{$competition->description_bn}}</textarea>
                                ...
                                <select name="campaign" id="campaign"
                                    ...
                                    @if($campaigns)
                                        @foreach($campaigns as $campaign)
                                            <option value="{{$campaign->id}}" {{$campaign->id == $competition->campaign->id?'selected':''}}>{{$campaign->title}}</option>
                                        @endforeach
                                    @endif
                                </select>
                                @error('campaign')
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" name="date" autocomplete="off" placeholder="DD-MM-YYYY"
                                           value="{{date('d/m/Y h:i a',strtotime($competition->start_date))}} - {{date('d/m/Y h:i a',strtotime($competition->end_date))}}" id="date"
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" value="{{$competition->location}}" name="location" id="location"
            ...
            <div class="col-lg-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h6>Competition Thumbnail</h6>
                        <img src="{{asset("uploads/competition/$competition->cover")}}" class="img-thumbnail" alt="">
                    </div>
                </div>
            </div>
            <!-- end -->
