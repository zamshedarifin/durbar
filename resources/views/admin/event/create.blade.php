...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div>
                    <h4 class="header-title mb-3 text-uppercase">Create Event</h4>
                </div>
            </div>
        </div>
        <!-- end row -->
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        <form class="form-row" action="{{route('admin.create.event')}}"
                            ...
                            <div class="form-group col-md-6">
                                <label for="location_bn">Location <span
                                        class="text-success">[বাংলা]</span></label>
                                <input type="text" value="{{old('location_bn')}}" name="location_bn" id="location_bn"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" name="event_date" autocomplete="off" placeholder="DD-MM-YYYY"
                                           value="{{old('event_date')}}" id="event_date"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input value="{{old('event_link')}}" type="text" name="event_link" id="event_link"
